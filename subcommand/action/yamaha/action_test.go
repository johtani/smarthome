...
func TestActions(t *testing.T) {
	mock := &mockYamahaAPI{
		setSceneFunc: func(_ context.Context, scene int) error {
			return nil
		},
		setVolumeFunc: func(_ context.Context, volume int) error {
			return nil
		},
		...
		setInputFunc: func(_ context.Context, input string) error {
			return nil
		},
	}
